var CONTRACT_ADDRESS = "TY5DLMmRm19ukxuhdn4vnhdWrgyUazGvgV";
var SOFT_LAUNCH = 1609765200; 
var FULL_LAUNCH = 1609804800; 
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var load_obj = setInterval(async ()=>{
      if (window.tronWeb && window.tronWeb.defaultAddress.base58) {
        ...
        document.getElementById("referral_link").value = "https://tron100.site?r="+window.tronified.address;
